...
public class P1_cssSelector_Cybertek {
    ...
    public static void main(String[] args) {
        ...
        WebElement retrievePasswordButton = driver.findElement(By.cssSelector("div[style='text-align: center;']"));
        ...
        System.out.println("forgotPasswordHeather.isDisplayed() = " + forgotPasswordHeader.isDisplayed() );
